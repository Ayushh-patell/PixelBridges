...
<h1 className={` ${bebas.className} lg:gap-[45px] md:gap-[35px] sm3:gap-[25px] gap-4 xl1:text-5xl lg:text-4xl md:text-2xl text-xl flex justify-center items-center lg:pb-5 sm3:pb-10 pb-5 lg:pt-20 pt-[13dvh] mix-blend-overlay`}>
  <span>P</span>
  <span>I</span>
  <span>X</span>
  <span>E</span>
...
<div className=" sm1:hidden block w-max relative text-left text-4xl font-[family-name:var(--font-nexa)] mx-auto">
  ...
  <p className=" relative z-10 w-max">Bridging</p>
  <p className=" relative z-10 w-max">Ideas</p>
  <p className=" relative z-10 w-max">into the</p>
  <p className=" relative z-10 w-max">Digital</p>
  <p className=" relative z-10 w-max">World</p>
  <p className=" relative z-10 w-full text-center">“</p>

  <div aria-hidden className=" bg-mainBg absolute top-1/2 -translate-y-1/2 left-0 h-[80%] w-1/4 z-0"/>
</div>
</div>
      ...
      <div className=" sm1:w-3/4 w-screen h-28 bg-white mix-blend-overlay sm1:-translate-x-10 -translate-x-[1.7rem] absolute z-[-5] sm1:top-1/2 sm1:bottom-auto bottom-0 sm1:-translate-y-1/2 left-0"/>
        <div className={` sm1:w-3/4 w-full flex-shrink-0 h-28 text-white lg:text-base md:text-xs sm4:text-[10px] text-[8px] sm1:-translate-x-10 sm1:pl-10 flex sm1:flex-row flex-col sm1:justify-between justify-around items-center ${mont.className}`}>
        ...
        <div className=" sm1:w-1/4 sm4:w-1/2 w-2/3 bg-white/20 sm1:h-32 h-24 text-center flex flex-col justify-center items-center">
          <p className=" font-bold lg:text-6xl md:text-5xl sm1:text-4xl text-5xl sm1:text-white/90 text-white/20">100+</p>
