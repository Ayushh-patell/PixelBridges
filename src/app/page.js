...
<div className=" sm1:hidden block w-max relative text-left text-4xl font-[family-name:var(--font-nexa)] mx-auto">
  ...
  <div aria-hidden className=" bg-mainBg absolute top-1/2 -translate-y-1/2 -left-3 h-[80%] w-[30%] z-0"/>
      ...
      <div className=" sm1:w-3/4 w-screen h-32 bg-white mix-blend-overlay sm1:-translate-x-10 -translate-x-[1.7rem] absolute z-[-5] sm1:top-1/2 sm1:bottom-auto bottom-0 sm1:-translate-y-1/2 left-0"/>
        <div className={` sm1:w-3/4 w-full flex-shrink-0 h-32 text-white lg:text-xl md:text-xs sm4:text-[10px] text-[8px] sm1:-translate-x-10 sm1:pl-10 flex sm1:flex-row flex-col sm1:justify-between justify-around items-center sm:pr-5 xl:gap-48 md:gap-20 sm2:gap-3 gap-0 ${mont.className}`}>
          <p className=' font-bold flex flex-col justify-center sm1:items-start items-center sm1:text-left text-center lg:text-base'>
          <span className=" lg:text-xl md:text-xs text-[10px] text-white">At Pixelbridges, we turn your website into a powerful tool</span> 
        ...
        <div className=" sm1:w-1/4 sm4:w-1/2 w-2/3 bg-white/20 sm1:h-36 h-24 text-center flex flex-col justify-center items-center">
