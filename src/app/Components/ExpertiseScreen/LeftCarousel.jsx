...
const LeftCarousel = () => {
  return (
    ...
    <div id='leftcarouselText' className=' bg-[#1A181D] rounded-full lg:px-16 px-10 lg:py-5 py-3 text-lg z-20 absolute top-1/2 -translate-y-1/2 left-[11.5%]'>New Name and Identity</div>
